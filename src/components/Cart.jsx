    ...
    return (
        <div className="container mb-5">
            <div className="d-flex flex-row align-items-start">
                ...
                <h2>Cart:{!items.length? ' Your cart is empty':null}</h2>
                    {items.map((item) => {
                        return (
                            <div className="cart-item p-3">
                                <div className="d-flex flex-row">
                                    ...
                                    <div onClick={()=>removeItem(item)}
                                        ...
                                        <i className="fa-solid fa-x bi bi-x-circle"></i>
               ...
               {order.items.length?<div className="col-4 order p-3 m-2">
                    ...
                    <div className="d-flex flex-row justify-content-between p-2">
                        {/* <span className="billing-item">Discount ({order.total_cost * order.discount_in_percent}%)</span> */}
                    ...
                    <div className="d-flex mt-3">
                        <Link to="/checkoutPage" className="btn btn-primary flex-grow-1">Pay Now</Link>
                    </div>
                </div>:null} 
            </div>
        </div>
